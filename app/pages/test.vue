...
<script lang="ts" setup>
    ...
    function createObject(
        ...
        enemydata?: enemy){
            ...
            createdObjects.push({Visual: cube, Hitbox: hitboxdesc, Box: box3, OBBLocal: obbLocal, OBBWorld: obbWorld})
    ...
    onMounted(()=>{
        ...
        const animate = (): void => {
            ...
            enemies.forEach((x)=>{
                ...
                if (checkCollision({OBBLocal:x.OBBLocal, OBBWorld:x.OBBWorld, Visual:x.Visual}, {OBBLocal:plr.OBBLocal, OBBWorld:plr.OBBWorld, Visual:plr.Visual}) && !reloading){
                    reloading = true
                    location.reload()
                }
            })
